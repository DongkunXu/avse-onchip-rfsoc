...
|---|---|---|---|---|---|---|---|---|---|
| **p2-c7-full** | — | C7 Conv-TasNet (mask) | 0.017 MB | — | — | — | 308,544 | **PENDING (owner-run)** | full data (315k win), 80 epochs, early-stop 5, NaN-guarded harness. The definitive quality model; export its best.pt into the HLS ROMs after. |
